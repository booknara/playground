...
public class KthLargestElementInArrayTest {
    ...
    public void findKthLargest() {
        ...
        Assert.assertEquals(5, kthLargestElementInArray.findKthLargest1(new int[] {3,2,1,5,6,4}, 2));
        Assert.assertEquals(1, kthLargestElementInArray.findKthLargest1(new int[] {3,2,3,1,2,4,5,5,6}, 9));
