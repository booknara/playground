package com.booknara.practice.kotlin.lambdas
...
//    println("Pass 10, 11 to to intLambda : ${intLambda.invoke(10, 11)}")
//
...
//    myLambda()
    ...
    var kgsToPoundsLambda = getConversionLambda("KgsToPounds")
    var poundsToUSTonsLambda = getConversionLambda("PoundsToUSTons")
